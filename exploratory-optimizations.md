...
| scene | cycles (final) | tex-lookahead Δ | cov$ v2 Δ | VO 1px/clk Δ | bound by |
|---|---|---|---|---|---|
| shenmue_intro2 | 2,589,816 | −50,085 | −75,814 | −1,023 | geometry (raster) |
| sonic | 2,558,918 | −7,762 | −23,999 | −1,023 | geometry |
| hotd2_car_fire | 1,449,432 | −133,482 | −5,289 | −59,156 | mixed |
| shenmue_menu | 1,248,006 | −152,093 | +99 | −1,023 | texture |
| hotd2_gargoyle | 1,174,477 | −96,332 | −1,009 | −41,138 | mixed |
...
| More color halves | VO-bound scenes — now much weaker after the 1 px/clk VO fix (daytona/menu2/selfie already gained 4-7%) | small | M10K |
